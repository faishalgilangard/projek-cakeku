                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $statusMapping = [
                                ...
                                1 => ['label' => 'Selesai', 'class' => 'bg-success'],
                                2 => ['label' => 'Cancel', 'class' => 'bg-danger']
                            ];
                            $statusInt = (int) $item['status'];
                            $status = $statusMapping[$statusInt] ?? ['label' => 'Tidak Diketahui', 'class' => 'bg-secondary'];
                            ?>
